...
public class SpawnTemplates {
    ...
    static void addSherbetLandMobs(SpawnSettings.Builder builder) {
        ...
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.RABBIT, 80, 2, 4));
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityRegistry.KOOPA_TROOPA, 18, 2, 4));
        builder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityRegistry.PARATROOPA, 6, 2, 4));
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.BOO, 4, 2, 4));
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.FIRE_BRO, 2, 2, 4));
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.ICE_BRO, 4, 2, 4));
        addGoombas(builder);
    }
    ...
    static void addAutumnForestMobs(SpawnSettings.Builder builder) {
        ...
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.FIRE_BRO, 5, 2, 4));
    ...
    static void addDryDryDesertMobs(SpawnSettings.Builder builder) {
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.HAMMER_BRO, 3, 2, 4));
        builder.spawn(SpawnGroup.MONSTER, new SpawnSettings.SpawnEntry(EntityRegistry.FIRE_BRO, 2, 2, 4));
        addGoombas(builder);
    }
