...
import com.dayofpi.super_block_world.registry.world.feature.utility.RuleTests;
...
public class ConfiguredOres {
    ...
    public static final ConfiguredFeature<?, ?> ORE_CERISE = Feature.ORE.configure(new OreFeatureConfig(RuleTests.ROYALITE, BlockInit.CERISE_ORE.getDefaultState(),9));
