...
public class KoopaModel<T extends KoopaEntity> extends SinglePartEntityModel<T> {
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.RIGHT_WING.pitch = MathHelper.cos(l) * 0.2F -0.5672F;
        this.LEFT_WING.pitch = MathHelper.cos(l) * 0.2F -0.5672F;
        ...
        this.RIGHT_WING.roll =  MathHelper.cos(limbAngle * 0.6662F + 3.1415927F) * limbDistance - 0.2F;
        this.LEFT_WING.roll =  MathHelper.cos(limbAngle * 0.6662F) * limbDistance + 0.2F;
    }
}
