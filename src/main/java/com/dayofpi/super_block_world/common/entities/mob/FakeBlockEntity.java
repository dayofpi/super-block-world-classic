...
import com.dayofpi.super_block_world.client.main.GlobalReceivers;
...
public class FakeBlockEntity extends AbstractEnemy implements IAnimatable {
    final AnimationFactory factory = new AnimationFactory(this);
    private boolean twirling = false;

    public FakeBlockEntity(EntityType<? extends AbstractEnemy> entityType, World world) {
