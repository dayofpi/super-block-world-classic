...
public class MushroomKingdom {
    ...
    // The PRESET field is used in data. Do not delete
    ...
    public static void initializeDimension() {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) ->
                dispatcher.register(literal("tp_to_kingdom").executes(MushroomKingdom::swapTargeted))
        );
    }
    ...
    private static int swapTargeted(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        if (serverWorld != modWorld) {
            ...
            modWorld.setBlockState(new BlockPos(0, 99, 0), Blocks.DIAMOND_BLOCK.getDefaultState());
            modWorld.setBlockState(new BlockPos(0, 100, 0), ColoredBlocks.YELLOW_WARP_PIPE.getDefaultState());
        } else {
