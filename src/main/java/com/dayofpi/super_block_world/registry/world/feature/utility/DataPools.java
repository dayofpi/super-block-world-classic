...
import com.dayofpi.super_block_world.common.block.mechanics.CoinBlock;
import com.dayofpi.super_block_world.common.block.plant.BushBlock;
import com.dayofpi.super_block_world.common.block.plant.PiranhaLilyBlock;
...
public class DataPools {
    ...
    public static final DataPool.Builder<BlockState> CAVE_DECORATION_RARE_POOL = DataPool.<BlockState>builder().add(BlockInit.STONE_TORCH.getDefaultState(), 1).add(BlockInit.STONE_TORCH.getDefaultState().with(Properties.LIT, false), 1);
}
