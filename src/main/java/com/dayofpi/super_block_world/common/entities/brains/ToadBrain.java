...
public class ToadBrain {
    public static Brain<?> create(Brain<ToadEntity> brain) {
    ...
    private static void addCoreActivities(Brain<ToadEntity> brain) {
    ...
    private static void addIdleActivities(Brain<ToadEntity> brain) {
    ...
    public static void updateActivities(ToadEntity spindrift) {
