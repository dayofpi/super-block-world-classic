...
public class ConfiguredVegetation {
    ...
    private static final PlacementModifier CANYON_PLACEMENT = BlockFilterPlacementModifier.of(BlockPredicate.allOf(BlockPredicate.IS_AIR_OR_WATER, BlockPredicate.matchingBlocks(List.of(BlockRegistry.VANILLATE, BlockRegistry.HARDSTONE), new Vec3i(0, -1, 0))));
    ...
    public static final ConfiguredFeature<?, ?> FLOWER_GORGE = Feature.FLOWER.configure(new RandomPatchFeatureConfig(64, 7, 3, () -> Feature.SIMPLE_BLOCK.configure(new SimpleBlockFeatureConfig(BlockStateProvider.of(PlantBlocks.PINK_SONGFLOWER))).withPlacement(BlockFilterPlacementModifier.of(BlockPredicate.IS_AIR))));
    ...
    public static final ConfiguredFeature<?, ?> VEGETATION_GORGE_TALL = Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(List.of(new RandomFeatureEntry(ConfiguredTrees.HUGE_GREEN_MUSHROOM_TALL.withPlacement(CANYON_PLACEMENT), 0.5F)), ConfiguredTrees.HUGE_RED_MUSHROOM_TALL.withPlacement(CANYON_PLACEMENT)));

    public static final ConfiguredFeature<?, ?> VEGETATION_CAVE = Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(List.of(new RandomFeatureEntry(BEANSTALK_BUDDING.withPlacement(), 0.5F), new RandomFeatureEntry(BEANSTALK_NOT_BUDDING.withPlacement(), 0.5F), new RandomFeatureEntry(PlacedTrees.HUGE_GREEN_MUSHROOM_FLAT, 0.5F), new RandomFeatureEntry(ConfiguredTrees.HUGE_YELLOW_MUSHROOM.withPlacement(), 0.5F),  new RandomFeatureEntry(ConfiguredTrees.HUGE_ORANGE_MUSHROOM.withPlacement(), 0.5F)), ConfiguredTrees.HUGE_RED_MUSHROOM_FLAT.withPlacement()));
}
