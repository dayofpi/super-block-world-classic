...
public class ModMusic {
    ...
    public static final MusicSound ILLUSION = new MusicSound(ModSounds.MUSIC_ILLUSION, 6000, 14000, false);
    public static final MusicSound WATER = new MusicSound(ModSounds.MUSIC_WATER, 6000, 14000, false);
    public static final MusicSound CAVE = new MusicSound(ModSounds.MUSIC_CAVE, 6000, 20000, false);
}