package com.dayofpi.super_block_world.main.registry.general;
...
public class EntityRegistry {
    ...
    public static final EntityType<EnemyIceballEntity> ENEMY_ICEBALL = FabricEntityTypeBuilder.<EnemyIceballEntity>create(SpawnGroup.MISC, EnemyIceballEntity::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).trackRangeBlocks(4).trackedUpdateRate(20).build();
    ...
    public static void registerEntities() {
        ...
        register("enemy_iceball", ENEMY_ICEBALL);
