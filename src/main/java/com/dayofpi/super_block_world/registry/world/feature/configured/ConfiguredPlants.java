...
import com.dayofpi.super_block_world.registry.world.feature.placed.PlacedPlants;
import com.dayofpi.super_block_world.registry.world.feature.utility.BlockLists;
import com.dayofpi.super_block_world.registry.world.feature.utility.DataPools;
...
public class ConfiguredPlants {
    ...
    public static final ConfiguredFeature<?, ?> TALL_GRASS_PATCH = Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig(256, 32, 2, () -> Feature.SIMPLE_BLOCK.configure(new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.TALL_GRASS))).withPlacement(BlockFilterPlacementModifier.of(BlockPredicate.IS_AIR))));
