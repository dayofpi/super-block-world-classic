...
public class ModEntities {
    ...
    public static final EntityType<BoomerangEntity> BOOMERANG = FabricEntityTypeBuilder.<BoomerangEntity>create(SpawnGroup.MISC, BoomerangEntity::new).dimensions(EntityDimensions.fixed(0.5F, 0.3F)).trackRangeBlocks(4).trackedUpdateRate(10).build();
    public static final EntityType<BuzzyBeetleEntity> BUZZY_BEETLE = FabricEntityTypeBuilder.createMob().entityFactory(BuzzyBeetleEntity::new).spawnGroup(SpawnGroup.MONSTER).spawnRestriction(SpawnRestriction.Location.NO_RESTRICTIONS, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AbstractBuzzy::canSpawn).defaultAttributes(AbstractBuzzy::createBuzzyAttributes).dimensions(EntityDimensions.changing(1.2F, 1.0F)).build();
    ...
    public static final EntityType<KingBooEntity> KING_BOO = FabricEntityTypeBuilder.createMob().entityFactory(KingBooEntity::new).spawnGroup(SpawnGroup.MISC).trackRangeChunks(10).defaultAttributes(KingBooEntity::createKingBooAttributes).dimensions(EntityDimensions.fixed(2.0F, 2.0F)).build();
    ...
    public static final EntityType<MudTrooperEntity> MUD_TROOPER = FabricEntityTypeBuilder.createMob().entityFactory(MudTrooperEntity::new).spawnGroup(SpawnGroup.MONSTER).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, RottenMushroomEntity::canSpawn).defaultAttributes(MudTrooperEntity::createMudTrooperAttributes).dimensions(EntityDimensions.fixed(0.9F, 0.9F)).build();
    public static final EntityType<MummyMeEntity> MUMMY_ME = FabricEntityTypeBuilder.createMob().entityFactory(MummyMeEntity::new).spawnGroup(SpawnGroup.MONSTER).defaultAttributes(MummyMeEntity::createMummyMeAttributes).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MummyMeEntity::canSpawn).dimensions(EntityDimensions.changing(0.6F, 1.8F)).build();
    ...
    public static final EntityType<RottenMushroomEntity> ROTTEN_MUSHROOM = FabricEntityTypeBuilder.createMob().entityFactory(RottenMushroomEntity::new).spawnGroup(SpawnGroup.MONSTER).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, RottenMushroomEntity::canSpawn).defaultAttributes(RottenMushroomEntity::createRottenMushroomAttributes).dimensions(EntityDimensions.fixed(0.7F, 0.7F)).build();
    public static final EntityType<ShyGuyEntity> SHY_GUY = FabricEntityTypeBuilder.createMob().entityFactory(ShyGuyEntity::new).spawnGroup(SpawnGroup.MONSTER).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ShyGuyEntity::canSpawn).defaultAttributes(ShyGuyEntity::createShyGuyAttributes).dimensions(EntityDimensions.fixed(0.8F, 0.8F)).build();
    public static final EntityType<SleepySheepEntity> SLEEPY_SHEEP = FabricEntityTypeBuilder.createMob().entityFactory(SleepySheepEntity::new).spawnGroup(SpawnGroup.CREATURE).defaultAttributes(SleepySheepEntity::createSleepySheepAttributes).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::isValidNaturalSpawn).dimensions(EntityDimensions.changing(0.7F, 0.7F)).build();
    public static final EntityType<SpikeTopEntity> SPIKE_TOP = FabricEntityTypeBuilder.createMob().entityFactory(SpikeTopEntity::new).spawnGroup(SpawnGroup.MONSTER).spawnRestriction(SpawnRestriction.Location.NO_RESTRICTIONS, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AbstractBuzzy::canSpawn).defaultAttributes(SpikeTopEntity::createSpikeTopAttributes).dimensions(EntityDimensions.fixed(1.2F, 1.0F)).build();
    public static final EntityType<SpindriftEntity> SPINDRIFT = FabricEntityTypeBuilder.createMob().entityFactory(SpindriftEntity::new).spawnGroup(SpawnGroup.CREATURE).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, SpindriftEntity::canSpawn).defaultAttributes(SpindriftEntity::createSpindriftAttributes).dimensions(EntityDimensions.fixed(0.6F, 0.7F)).build();
    ...
    public static final EntityType<StarBitEntity> STAR_BIT = FabricEntityTypeBuilder.create(SpawnGroup.MISC, StarBitEntity::new).dimensions(EntityDimensions.fixed(0.25F, 0.25F)).trackRangeBlocks(4).trackedUpdateRate(10).build();
