...
import com.dayofpi.super_block_world.common.block_entity.BooLanternBE;
...
public class BooLantern extends BlockWithEntity {
    ...
    public BooLantern(Settings settings) {
        super(settings);
