...
import com.dayofpi.super_block_world.world.feature.configured.ConfiguredOres;
...
public class PlacedOres {
    ...
    public static final PlacedFeature TOPPING_AMETHYST = ConfiguredOres.TOPPING_AMETHYST.withPlacement(CountPlacementModifier.of(3), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.belowTop(0)), BiomePlacementModifier.of());
