...
import com.dayofpi.super_block_world.common.block.decoration.MushroomCap;
...
public class MushroomBlocks {
    ...
    public static final Block BROWN_MUSHROOM_CAP = new MushroomCap(false, FabricBlockSettings.of(Material.SOLID_ORGANIC, MapColor.DIRT_BROWN).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK));
    public static final Block ORANGE_MUSHROOM_CAP = new MushroomCap(true, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.ORANGE));
    public static final Block PURPLE_MUSHROOM_CAP = new MushroomCap(false, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.PURPLE));
    public static final Block PINK_MUSHROOM_CAP = new MushroomCap(true, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.PINK));
    public static final Block GREEN_MUSHROOM_CAP = new MushroomCap(false, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.EMERALD_GREEN));
    public static final Block YELLOW_MUSHROOM_CAP = new MushroomCap(false, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.YELLOW));
    public static final Block RED_MUSHROOM_CAP = new MushroomCap(true, FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.RED));
