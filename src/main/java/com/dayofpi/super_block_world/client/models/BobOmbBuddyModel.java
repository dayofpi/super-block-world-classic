...
public class BobOmbBuddyModel<T extends BobOmbBuddyEntity> extends AnimatedGeoModel<T> {
    @Override
    ...
    public Identifier getTextureResource(T object) {
        return new Identifier(Main.MOD_ID, "textures/entity/bob_omb_buddy.png");
    }
