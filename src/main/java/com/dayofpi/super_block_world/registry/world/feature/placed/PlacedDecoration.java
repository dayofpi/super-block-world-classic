...
import com.dayofpi.super_block_world.registry.world.feature.configured.ConfiguredDecoration;
...
public class PlacedDecoration {
    ...
    public static final PlacedFeature SPRING_WATER = ConfiguredDecoration.SPRING.withPlacement(CountPlacementModifier.of(4), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.belowTop(0)), BiomePlacementModifier.of());
    ...
    public static final PlacedFeature LAKE_POISON = ConfiguredDecoration.LAKE_POISON.withPlacement(RarityFilterPlacementModifier.of(9), SquarePlacementModifier.of(), HeightRangePlacementModifier.trapezoid(YOffset.fixed(0), YOffset.fixed(200)), BiomePlacementModifier.of());
