...
public class PlacedVegetation {
    ...
    public static final PlacedFeature AMANITA_CARPET = ConfiguredVegetation.AMANITA_CARPET.withPlacement(CountPlacementModifier.of(170), HeightRangePlacementModifier.uniform(YOffset.fixed(60), YOffset.fixed(200)), SquarePlacementModifier.of(), BiomePlacementModifier.of());
    ...
    public static final PlacedFeature CACTUS = ConfiguredVegetation.CACTUS.withPlacement(BlockFilterPlacementModifier.of(BlockPredicate.allOf(BlockPredicate.IS_AIR, BlockPredicate.matchingBlockTag(BlockTags.SAND, new Vec3i(0, -1, 0)))));
    public static final PlacedFeature CACTUS_PATCH = ConfiguredVegetation.CACTUS_PATCH.withPlacement(RarityFilterPlacementModifier.of(16), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.WORLD_SURFACE_WG), BiomePlacementModifier.of());
    ...
    public static final PlacedFeature FUZZBUSH = ConfiguredVegetation.FUZZBUSH.withPlacement(RarityFilterPlacementModifier.of(30), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES), BiomePlacementModifier.of());
    public static final PlacedFeature PIRANHA_LILY = ConfiguredVegetation.PIRANHA_LILY.withPlacement(RarityFilterPlacementModifier.of(30), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES), BiomePlacementModifier.of());
