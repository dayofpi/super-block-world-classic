...
public class PeteyPiranhaModel extends SinglePartEntityModel<PeteyPiranhaEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		root.addChild("left_arm", ModelPartBuilder.create().uv(0, 52).mirrored().cuboid(0.0F, 0.0F, -5.0F, 20.0F, 0.0F, 10.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(4.0F, -10.0F, 4.0F));

		root.addChild("right_arm", ModelPartBuilder.create().uv(0, 52).cuboid(-20.0F, 0.0F, -5.0F, 20.0F, 0.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, -10.0F, 4.0F));

		root.addChild("neck", ModelPartBuilder.create().uv(30, 73).cuboid(-4.0F, -10.0F, -3.0F, 8.0F, 8.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -6.0F, 4.0F, -0.0873F, 0.0F, 0.0F));
		...
		bottom.addChild("bottom_leaves", ModelPartBuilder.create().uv(68, 18).cuboid(-8.0F, -4.0F, 0.0F, 16.0F, 8.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 11.0F, -8.0F, -0.4363F, 0.0F, 0.0F));

		bottom.addChild("tongue", ModelPartBuilder.create().uv(0, 62).cuboid(-4.0F, 0.0F, -1.0F, 8.0F, 3.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, -10.0F));
		...
		top.addChild("top_leaves", ModelPartBuilder.create().uv(68, 44).cuboid(-8.0F, -4.0F, 0.0F, 16.0F, 8.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -11.0F, -8.0F, 0.4363F, 0.0F, 0.0F));

		head.addChild("left_leaves", ModelPartBuilder.create().uv(0, 26).cuboid(-4.0F, -8.0F, 0.0F, 8.0F, 16.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(11.0F, -7.0F, -5.0F, 0.0F, 0.4363F, 0.0F));

		head.addChild("right_leaves", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, 0.0F, 8.0F, 16.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-11.0F, -7.0F, -5.0F, 0.0F, -0.4363F, 0.0F));

		root.addChild("right_leg", ModelPartBuilder.create().uv(74, 52).cuboid(-3.0F, 0.0F, -3.0F, 5.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.5F, 0.0F, 4.0F));

		root.addChild("left_leg", ModelPartBuilder.create().uv(74, 52).mirrored().cuboid(-2.0F, 0.0F, -3.0F, 5.0F, 6.0F, 6.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(2.5F, 0.0F, 4.0F));
