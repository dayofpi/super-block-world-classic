...
public class DryBonesLayer<T extends DryBonesEntity> extends GeoLayerRenderer<T> {
    private static final Identifier MODEL = new Identifier(Main.MOD_ID, "geo/dry_bones.geo.json");
    private static final Identifier EYES = new Identifier(Main.MOD_ID, "textures/entity/koopa/dry_bones_eyes.png");
    public DryBonesLayer(IGeoRenderer<T> geoRenderer) {
        super(geoRenderer);
    }
