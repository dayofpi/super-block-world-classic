...
public class BeeWingsFeatureRenderer<T extends PlayerEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
    private static final Identifier TEXTURE = new Identifier(Main.MOD_ID, "textures/entity/power_up/bee_wings.png");
    private final EntityModel<PlayerEntity> model;

    public BeeWingsFeatureRenderer(FeatureRendererContext<T, M> context, EntityModelLoader loader) {
        super(context);
        this.model = new PowerUpModel(loader.getModelPart(ModModelLayers.BEE_WINGS));
    }
