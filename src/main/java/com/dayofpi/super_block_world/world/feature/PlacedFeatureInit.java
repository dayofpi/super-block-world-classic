...
public class PlacedFeatureInit {
    ...
    public static void registerPlacedFeatures() {
        registerPlacedFeature("spring_high", PlacedDecoration.SPRING_HIGH);
        registerPlacedFeature("spring_low", PlacedDecoration.SPRING_LOW);
        registerPlacedFeature("lake_lava", PlacedDecoration.LAKE_LAVA);
        registerPlacedFeature("lake_ice", PlacedDecoration.LAKE_ICE);
        ...
        registerPlacedFeature("freezie", PlacedDecoration.FREEZIE);
        ...
        registerPlacedFeature("jellybeam_reef", PlacedBlocks.JELLYBEAM_REEF);
        registerPlacedFeature("jellybeam_caves", PlacedBlocks.JELLYBEAM_CAVES);
        registerPlacedFeature("block_single", PlacedBlocks.BLOCK_SINGLE);
        registerPlacedFeature("block_line_surface", PlacedBlocks.BLOCK_LINE_SURFACE);
        registerPlacedFeature("block_line_surface_crystal", PlacedBlocks.BLOCK_LINE_SURFACE_CRYSTAL);
        registerPlacedFeature("block_line_deep", PlacedBlocks.BLOCK_LINE_DEEP);
        registerPlacedFeature("block_line_deep_crystal", PlacedBlocks.BLOCK_LINE_DEEP_CRYSTAL);
        registerPlacedFeature("block_line_lava", PlacedBlocks.BLOCK_LINE_LAVA);
        registerPlacedFeature("block_pile", PlacedBlocks.BLOCK_PILE);
