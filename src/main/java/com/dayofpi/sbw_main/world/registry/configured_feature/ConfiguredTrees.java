...
public class ConfiguredTrees {
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> DARK_AMANITA = Feature.TREE.configure((new TreeFeatureConfig.Builder(BlockStateProvider.of(States.DARK_AMANITA_LOG), new DarkOakTrunkPlacer(3, 3, 1), BlockStateProvider.of(States.AMANITA_LEAVES), new LargeOakFoliagePlacer(ConstantIntProvider.create(3), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().dirtProvider(BlockStateProvider.of(ModBlocks.TOADSTOOL_GRASS.getDefaultState())).build());
    public static final ConfiguredFeature<TreeFeatureConfig, ?> DARK_AMANITA_TALL = Feature.TREE.configure((new TreeFeatureConfig.Builder(BlockStateProvider.of(States.DARK_AMANITA_LOG), new DarkOakTrunkPlacer(10, 9, 7), new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(States.AMANITA_LEAVES, 10).add(States.FRUITING_AMANITA_LEAVES, 1)), new DarkOakFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0)), new ThreeLayersFeatureSize(1, 1, 1, 1, 2, OptionalInt.empty()))).ignoreVines().dirtProvider(BlockStateProvider.of(ModBlocks.TOADSTOOL_GRASS.getDefaultState())).build());
    ...
    public static final ConfiguredFeature<?, ?> HUGE_YELLOW_MUSHROOM = ModFeature.HUGE_MUSHROOM.configure(new GiantMushroomFeatureConfig(BlockStateProvider.of(States.YELLOW_MUSHROOM_CAP), BlockStateProvider.of(States.MUSHROOM_STEM), UniformIntProvider.create(4, 8), UniformIntProvider.create(2, 3), true));
