...
public class BlockEntityRegistry {
    ...
    public static void registerBlockEntities() {
        ...
        SIGN = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Main.MOD_ID, "sign"), FabricBlockEntityTypeBuilder.create(SignBlockEntity::new, BlockRegistry.AMANITA_SIGN, BlockRegistry.AMANITA_WALL_SIGN, BlockRegistry.DARK_AMANITA_SIGN, BlockRegistry.DARK_AMANITA_WALL_SIGN).build());
    }
}
