package com.dayofpi.super_block_world.main.client.entity.renderer.other;

import com.dayofpi.super_block_world.main.Main;
import com.dayofpi.super_block_world.main.client.entity.model.BuzzyShellModel;
...
public class BuzzyShellRenderer<T extends BuzzyShellEntity> extends EntityRenderer<T> {
    ...
    public void render(T entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (entity.isActive())
            matrixStack.multiply(Vec3f.POSITIVE_Y.getDegreesQuaternion(entity.age * 20));
        else
