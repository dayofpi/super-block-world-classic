...
public class CustomHugeMushroomFeature extends Feature<CustomHugeMushroomFeatureConfig> {
    public CustomHugeMushroomFeature(Codec<CustomHugeMushroomFeatureConfig> codec) {
        super(codec);
    }

    protected void generateStem(WorldAccess world, Random random, BlockPos pos, CustomHugeMushroomFeatureConfig config, int height, BlockPos.Mutable mutable) {
    ...
    protected boolean canGenerate(WorldAccess world, BlockPos pos, int height, BlockPos.Mutable mutable, CustomHugeMushroomFeatureConfig config) {
        int i = pos.getY();
    ...
    public boolean generate(FeatureContext<CustomHugeMushroomFeatureConfig> context) {
        StructureWorldAccess structureWorldAccess = context.getWorld();
        BlockPos blockPos = context.getOrigin();
        Random random = context.getRandom();
        CustomHugeMushroomFeatureConfig hugeMushroomFeatureConfig = context.getConfig();
    ...
    protected void generateConeCap(WorldAccess world, Random random, BlockPos start, int y, BlockPos.Mutable mutable, CustomHugeMushroomFeatureConfig config) {
        for(int i = y - 3; i <= y; ++i) {
    ...
    protected void generateFlatCap(WorldAccess world, Random random, BlockPos start, int y, BlockPos.Mutable mutable, CustomHugeMushroomFeatureConfig config) {
