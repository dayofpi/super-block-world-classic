...
public class ConfiguredFeatures {
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> HUGE_RED_MUSHROOM_FLAT = new ConfiguredFeature<>(Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(Blocks.RED_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> HUGE_GREEN_MUSHROOM_FLAT = new ConfiguredFeature<>(Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.GREEN_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> TALL_RED_MUSHROOM = new ConfiguredFeature<>(Features.TALL_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(Blocks.RED_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 2));
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> ORANGE_MUSHROOM_CAP = new ConfiguredFeature<>(Features.MUSHROOM_CAP, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.ORANGE_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    ...
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> HUGE_PURPLE_MUSHROOM = new ConfiguredFeature<>(Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.PURPLE_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> HUGE_ORANGE_MUSHROOM = new ConfiguredFeature<>(Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.ORANGE_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    public static final ConfiguredFeature<HugeMushroomFeatureConfig, ?> HUGE_PINK_MUSHROOM = new ConfiguredFeature<>(Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.PINK_MUSHROOM_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(Blocks.MUSHROOM_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 3));
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> AMANITA_REEF = new ConfiguredFeature<>(Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(ModBlocks.AMANITA_LOG), new StraightTrunkPlacer(3, 2, 1), new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(ModBlocks.AMANITA_LEAVES.getDefaultState(), 7).add(ModBlocks.FRUITING_AMANITA_LEAVES.getDefaultState(), 1)), new LargeOakFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0), 3), new TwoLayersFeatureSize(1, 0, 1)).dirtProvider(BlockStateProvider.of(ModBlocks.SHOREGRASS)).decorators(List.of(new AlterGroundTreeDecorator(BlockStateProvider.of(ModBlocks.SHOREGRASS)))).build());
    ...
    public static void register() {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "huge_green_mushroom_flat"), HUGE_GREEN_MUSHROOM_FLAT);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "tall_red_mushroom"), TALL_RED_MUSHROOM);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "orange_mushroom_cap"), ORANGE_MUSHROOM_CAP);
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "amanita_reef"), AMANITA_REEF);
