...
public class PlacedOres {
    ...
    public static final PlacedFeature ORE_VANILLATE_COAL_EXTRA = ConfiguredOres.ORE_VANILLATE_COAL.withPlacement(CountPlacementModifier.of(5), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.fixed(63), YOffset.belowTop(0)), BiomePlacementModifier.of());
    public static final PlacedFeature VANILLATE_IRON_ORE = ConfiguredOres.ORE_VANILLATE_IRON.withPlacement(CountPlacementModifier.of(8), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.fixed(63)), BiomePlacementModifier.of());
    public static final PlacedFeature ORE_AMETHYST = ConfiguredOres.TOPPING_AMETHYST.withPlacement(CountPlacementModifier.of(2), SquarePlacementModifier.of(), HeightRangePlacementModifier.trapezoid(YOffset.fixed(-32), YOffset.fixed(20)), BiomePlacementModifier.of());
