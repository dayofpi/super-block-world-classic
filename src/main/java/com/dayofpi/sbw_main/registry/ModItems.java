...
public class ModItems {
    ...
    public static final Item YOSHI_FRUIT = new Item(new FabricItemSettings().food(ModFoodComponents.YOSHI_FRUIT).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item YOSHI_COOKIE = new Item(new FabricItemSettings().food(ModFoodComponents.YOSHI_COOKIE).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item TURNIP = new TurnipItem(new FabricItemSettings().maxCount(16).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item HAMMER = new HammerItem(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP).maxDamage(50));
    public static final Item BOMB = new BombItem(new FabricItemSettings().maxCount(16).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item SUPER_MUSHROOM = new SuperMushroomItem(new FabricItemSettings().food(ModFoodComponents.SUPER_MUSHROOM).maxCount(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item GOLDEN_MUSHROOM = new GoldenMushroomItem(new FabricItemSettings().food(ModFoodComponents.GOLDEN_MUSHROOM).maxCount(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item ONE_UP = new OneUpItem(new FabricItemSettings().food(ModFoodComponents.ONE_UP).maxCount(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item POISON_MUSHROOM = new Item(new FabricItemSettings().food(ModFoodComponents.POISON_MUSHROOM).maxCount(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item FIRE_FLOWER = new FireFlowerItem(new FabricItemSettings().maxDamage(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item ICE_FLOWER = new IceFlowerItem(new FabricItemSettings().maxDamage(16).group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.UNCOMMON));
    public static final Item SUPER_STAR = new SuperStarItem(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP).rarity(Rarity.RARE));
    public static final Item COIN = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item STAR_COIN = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item RAW_BRONZE = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BRONZE_INGOT = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item CERISE = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item TROOP_HIDE = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item CLOUD_PUFF = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item SPIKE = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BUZZY_SHELL_PIECE = new Item(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item GREEN_SHELL = new ShellItem(ModEntities.BUZZY_SHELL, GREEN_SHELL_ARMOR_MATERIAL, EquipmentSlot.HEAD, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item RED_SHELL = new ShellItem(ModEntities.BUZZY_SHELL, RED_SHELL_ARMOR_MATERIAL, EquipmentSlot.HEAD, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BUZZY_SHELL = new ShellItem(ModEntities.BUZZY_SHELL, BUZZY_ARMOR_MATERIAL, EquipmentSlot.HEAD, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item JUMP_BOOTS = new JumpBootsItem(JUMP_ARMOR_MATERIAL, EquipmentSlot.FEET, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BOTTLED_GHOST = new Item(new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item GREEN_MUSHROOM_ON_A_STICK = new OnAStickItem<>(new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP).maxDamage(25), ModEntities.BUZZY_BEETLE, 2);
    public static final Item AMANITA_BOAT = new BoatItem(ModBoatType.AMANITA, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP).maxCount(1));
    public static final Item DARK_AMANITA_BOAT = new BoatItem(ModBoatType.DARK_AMANITA, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP).maxCount(1));
    public static final Item POISON_BUCKET = new PoisonBucketItem(ModFluid.STILL_POISON, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1).group(ModCreativeTabs.ITEM_GROUP));
    public static final Item MOO_MOO_SPAWN_EGG = new SpawnEggItem(ModEntities.MOO_MOO, 15985102, 4605249, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item GOOMBA_SPAWN_EGG = new SpawnEggItem(ModEntities.GOOMBA, 12544546, 14922613, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item PARAGOOMBA_SPAWN_EGG = new SpawnEggItem(ModEntities.PARAGOOMBA, 12544546, 16767400, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item KOOPA_TROOPA_SPAWN_EGG = new SpawnEggItem(ModEntities.KOOPA_TROOPA, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item PARATROOPA_SPAWN_EGG = new SpawnEggItem(ModEntities.PARATROOPA, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item HAMMER_BRO_SPAWN_EGG = new SpawnEggItem(ModEntities.HAMMER_BRO, 16570144, 9341835, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item FIRE_BRO_SPAWN_EGG = new SpawnEggItem(ModEntities.FIRE_BRO, 16570144, 15552066, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BOB_OMB_SPAWN_EGG = new SpawnEggItem(ModEntities.BOB_OMB, 658473, 5688063, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BOO_SPAWN_EGG = new SpawnEggItem(ModEntities.BOO, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item BUZZY_BEETLE_SPAWN_EGG = new SpawnEggItem(ModEntities.BUZZY_BEETLE, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item SPIKE_TOP_SPAWN_EGG = new SpawnEggItem(ModEntities.SPIKE_TOP, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item NIPPER_PLANT_SPAWN_EGG = new SpawnEggItem(ModEntities.NIPPER_PLANT, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item STINGBY_SPAWN_EGG = new SpawnEggItem(ModEntities.STINGBY, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item ROTTEN_MUSHROOM_SPAWN_EGG = new SpawnEggItem(ModEntities.ROTTEN_MUSHROOM, 16777215, 16777215, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item THWOMP_SPAWN_EGG = new SpawnEggItem(ModEntities.THWOMP, 10530706, 12572889, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    public static final Item FAKE_BLOCK_SPAWN_EGG = new SpawnEggItem(ModEntities.FAKE_BLOCK, 10042394, 10042394, new FabricItemSettings().group(ModCreativeTabs.ITEM_GROUP));
    ...
    private static void registerBlockItem(String id, Block block) {
        Registry.register(Registry.ITEM, new Identifier(Main.MOD_ID, id), new BlockItem(block, new FabricItemSettings().group(ModCreativeTabs.BLOCK_GROUP)));
    }
    ...
    public static void registerBlockItems() {
        ...
        registerItem("piranha_lily", new PiranhaLilyItem(PlantBlocks.PIRANHA_LILY, new FabricItemSettings().group(ModCreativeTabs.BLOCK_GROUP)));
        ...
        registerBlockItem("cerise_ore", ModBlocks.CERISE_ORE);registerBlockItem("topped_vanillate", ModBlocks.TOPPED_VANILLATE);
        ...
        registerItem("amanita_sign", new SignItem(new FabricItemSettings().group(ModCreativeTabs.BLOCK_GROUP).maxCount(16), ModBlocks.AMANITA_SIGN, ModBlocks.AMANITA_WALL_SIGN));
        ...
        registerItem("dark_amanita_sign", new SignItem(new FabricItemSettings().group(ModCreativeTabs.BLOCK_GROUP).maxCount(16), ModBlocks.DARK_AMANITA_SIGN, ModBlocks.DARK_AMANITA_WALL_SIGN));
