...
public class EntityClient {
    public static void registerEntityRenderers() {
        ...
        EntityRendererRegistry.register(ModEntities.MOD_BOAT, ModBoatRenderer::new);
        EntityModelLayerRegistry.registerModelLayer(ModelLayers.MOD_BOAT, ModBoatModel::getTexturedModelData);
