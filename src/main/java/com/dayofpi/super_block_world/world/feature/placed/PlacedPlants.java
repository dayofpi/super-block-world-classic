...
import com.dayofpi.super_block_world.world.feature.configured.ConfiguredPlants;
...
public class PlacedPlants {
    ...
    public static final PlacedFeature PLANTS_GRASSLAND = ConfiguredPlants.PLANTS_GRASSLAND.withPlacement(CountPlacementModifier.of(7), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
    public static final PlacedFeature PLANTS_MEADOW = ConfiguredPlants.PLANTS_GRASSLAND.withPlacement(CountPlacementModifier.of(4), SquarePlacementModifier.of(), HeightmapPlacementModifier.of(Heightmap.Type.MOTION_BLOCKING), BiomePlacementModifier.of());
