...
public class MushroomKingdomChunkGenerator extends ChunkGenerator {
    public static final Codec<MushroomKingdomChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                            BiomeSource.CODEC.fieldOf("biome_source")
                                    .forGetter((generator) -> generator.biomeSource),
                            StructuresConfig.CODEC.fieldOf("structure_config")
                                    .forGetter(ChunkGenerator::getStructuresConfig)
                    )
                    .apply(instance, instance.stable(MushroomKingdomChunkGenerator::new))
    );

    public MushroomKingdomChunkGenerator(BiomeSource biomeSource, StructuresConfig structuresConfig) {
    ...
    public ChunkGenerator withSeed(long seed) {
        return new MushroomKingdomChunkGenerator(this.biomeSource.withSeed(seed), this.getStructuresConfig());
    }
