package com.dayofpi.super_block_world.main.client.sound;
...
public class ModSounds {
    ...
    public static void registerSounds() {
       ...
       registerSound(BLOCK_JELLYBEAM_DAMAGE.getId(), BLOCK_JELLYBEAM_DAMAGE);

       registerSound(ITEM_COLLECT_COIN.getId(), ITEM_COLLECT_COIN);
       registerSound(ITEM_COLLECT_STAR_COIN.getId(), ITEM_COLLECT_STAR_COIN);
       ...
       registerSound(ENTITY_KOOPA_DEATH.getId(), ENTITY_KOOPA_DEATH);
        ...
        registerSound(ENTITY_STINGBY_AMBIENT.getId(), ENTITY_STINGBY_AMBIENT);
        registerSound(ENTITY_STINGBY_HURT.getId(), ENTITY_STINGBY_HURT);
        registerSound(ENTITY_STINGBY_DEATH.getId(), ENTITY_STINGBY_DEATH);
        registerSound(ENTITY_STINGBY_STING.getId(), ENTITY_STINGBY_STING);
