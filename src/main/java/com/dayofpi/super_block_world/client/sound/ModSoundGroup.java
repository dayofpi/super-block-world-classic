...
public class ModSoundGroup {
    ...
    public static final BlockSoundGroup GRASSY_HARDSTONE = new BlockSoundGroup(1.0F, 0.8F, ModSounds.BLOCK_GRASSY_STONE_BREAK, ModSounds.BLOCK_GRASSY_STONE_STEP, ModSounds.BLOCK_GRASSY_STONE_PLACE, ModSounds.BLOCK_GRASSY_STONE_HIT, ModSounds.BLOCK_GRASSY_STONE_FALL);
