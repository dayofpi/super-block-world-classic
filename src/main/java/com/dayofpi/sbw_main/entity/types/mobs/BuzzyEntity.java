...
public class BuzzyEntity extends AbstractBuzzy implements ItemSteerable, Saddleable {
    ...
    public static boolean canSpawn(EntityType<BuzzyEntity> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityNbt) {
        if (this.isBaby()) {
            ...
            if (this.random.nextInt(20) == 0 && world.getBlockState(this.getBlockPos().up()).isAir()) {
                BuzzyEntity passiveEntity = ModEntities.BUZZY_BEETLE.create(world.toServerWorld());
    ...
    public BuzzyEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        ...
        return ModEntities.BUZZY_BEETLE.create(serverWorld);
    }
    ...
    public boolean canBeControlledByRider() {
        ...
        if (!(entity instanceof LivingEntity livingEntity)) {
            ...
            return livingEntity.getMainHandStack().isOf(ModItems.GREEN_MUSHROOM_ON_A_STICK) || livingEntity.getOffHandStack().isOf(ModItems.GREEN_MUSHROOM_ON_A_STICK);
        }
    }
