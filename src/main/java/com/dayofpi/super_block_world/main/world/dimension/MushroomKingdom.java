package com.dayofpi.super_block_world.main.world.dimension;
...
public class MushroomKingdom {
    ...
    public static void initializeDimension() {
        GENERATOR_SETTINGS_KEY = RegistryKey.of(Registry.CHUNK_GENERATOR_SETTINGS_KEY, new Identifier(Main.MOD_ID, "mushroom_kingdom"));
        DIMENSION_KEY = RegistryKey.of(Registry.DIMENSION_KEY, new Identifier(Main.MOD_ID, "mushroom_kingdom"));
        DIMENSION_TYPE_KEY = RegistryKey.of(Registry.DIMENSION_TYPE_KEY, new Identifier(Main.MOD_ID, "mushroom_kingdom"));
        ...
        ServerLifecycleEvents.SERVER_STARTED.register(server -> {
            ...
            ServerWorld mushroomKingdom = server.getWorld(WORLD_KEY);

            if (mushroomKingdom == null)
            ...
            Entity teleported = FabricDimensions.teleport(entity, mushroomKingdom, target);
