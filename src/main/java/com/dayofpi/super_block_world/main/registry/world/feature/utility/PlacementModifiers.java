...
public class PlacementModifiers {
    ...
    public static final PlacementModifier IN_CANYON = BlockFilterPlacementModifier.of(BlockPredicate.allOf(BlockPredicate.IS_AIR_OR_WATER, BlockPredicate.matchingBlocks(List.of(BlockInit.VANILLATE, BlockInit.HARDSTONE), UNDER)));
