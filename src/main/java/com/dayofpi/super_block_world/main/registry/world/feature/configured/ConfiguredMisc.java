...
public class ConfiguredMisc {
    private static final DataPool.Builder<BlockState> CAVE_DECORATION_COMMON_POOL = DataPool.<BlockState>builder().add(PlantBlocks.CAVE_MUSHROOMS.getDefaultState(), 50).add(MushroomBlocks.GREEN_MUSHROOM.getDefaultState(), 45).add(MushroomBlocks.YELLOW_MUSHROOM.getDefaultState(), 30).add(PlantBlocks.VEGETABLE.getDefaultState(), 10);
    private static final DataPool.Builder<BlockState> CAVE_DECORATION_RARE_POOL = DataPool.<BlockState>builder().add(BlockRegistry.STONE_TORCH.getDefaultState(), 1).add(BlockRegistry.STONE_TORCH.getDefaultState().with(Properties.LIT, false), 1);

    public static final ConfiguredFeature<?, ?> PIPE_PATCH = FeatureRegistry.EXTRA_RANDOM_PATCH.configure(new ExtraRandomPatchFeatureConfig(32, 1, 1,40, () -> PlacedMisc.PIPE));
