...
public class ConfiguredBlocks {
    ...
    private static final DataPool.Builder<BlockState> BLOCK_POOL_SURFACE = DataPool.<BlockState>builder().add(BlockRegistry.TOADSTONE_BRICKS.getDefaultState(), 8).add(BlockRegistry.QUESTION_BLOCK.getDefaultState(), 4).add(BlockRegistry.COIN_BLOCK.getDefaultState(), 3).add(BlockRegistry.DONUT_BLOCK.getDefaultState(), 1);
    ...
    public static final ConfiguredFeature<?, ?> BLOCK_PILE = Feature.BLOCK_COLUMN.configure(new BlockColumnFeatureConfig((BlockLists.BLOCK_PILE_LAYERS), Direction.UP, BlockPredicate.IS_AIR, false));
