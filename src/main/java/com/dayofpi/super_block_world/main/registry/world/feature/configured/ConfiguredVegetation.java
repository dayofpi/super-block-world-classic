...
public class ConfiguredVegetation {
    ...
    public static final ConfiguredFeature<?, ?> STUMP = Feature.BLOCK_COLUMN.configure(new BlockColumnFeatureConfig(List.of(BlockColumnFeatureConfig.createLayer(UniformIntProvider.create(1, 4), BlockStateProvider.of(BlockRegistry.AMANITA_LOG))), Direction.UP, BlockPredicate.IS_AIR, false));
    ...
    public static final ConfiguredFeature<?, ?> CACTUS_PATCH = Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig(64, 7, 3, () -> PlacedVegetation.CACTUS));
