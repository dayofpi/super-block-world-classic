...
import com.dayofpi.super_block_world.main.common.entity.projectile.TurnipEntity;
...
public class TurnipItem extends Item {
   ...
   public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
      ...
      world.playSound(null, user.getX(), user.getY(), user.getZ(), SoundInit.ITEM_PROJECTILE_GENERIC, SoundCategory.NEUTRAL, 0.5F, 1.0F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
