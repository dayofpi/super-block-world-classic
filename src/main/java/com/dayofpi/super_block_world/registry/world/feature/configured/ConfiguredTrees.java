...
public class ConfiguredTrees {
    ...
    static {
        BELL_TREE = Feature.TREE.configure(new TreeFeatureConfig.Builder(BlockStateProvider.of(States.BELL_LOG), new StraightTrunkPlacer(6, 5, 2), new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(States.BELL_CAP, 1).add(BlockInit.DARKENED_BELL_CAP.getDefaultState(), 1).build()), new LargeOakFoliagePlacer(UniformIntProvider.create(2, 3),UniformIntProvider.create(2, 3), 1), new TwoLayersFeatureSize(2, 0, 2)).ignoreVines().dirtProvider(BlockStateProvider.of(BlockInit.SHORESAND.getDefaultState())).build());
