...
public class GoopRenderer extends EntityRenderer<GoopEntity> {
    private static final Identifier TEXTURE = new Identifier(Main.MOD_ID, "textures/item/goop_ball.png");
    ...
    public void render(GoopEntity entity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        matrixStack.push();
