...
public class VanillateBlock extends Block {
    ...
    private  BlockState getToppedState(BlockState originalState) {
        return originalState.isOf(BlockRegistry.FROSTY_VANILLATE) ? BlockRegistry.FROSTY_TOPPED_VANILLATE.getDefaultState() : BlockRegistry.TOPPED_VANILLATE.getDefaultState();
    }
