...
import com.dayofpi.super_block_world.common.entities.mob.CeilingEntity;
...
public abstract class AbstractBuzzy extends CeilingEntity {
    ...
    public static boolean isSpawnBlockValid(WorldAccess world, BlockPos pos) {
        return world.getBlockState(pos).isOf(BlockInit.VANILLATE) || world.getBlockState(pos).isOf(BlockInit.TOPPED_VANILLATE) || world.getBlockState(pos).isOf(BlockInit.CHARROCK);
    }
