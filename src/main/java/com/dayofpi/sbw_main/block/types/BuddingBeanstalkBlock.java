...
public class BuddingBeanstalkBlock extends ModPlantStemBlock {
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        ...
        if (direction != this.growthDirection || !neighborState.isOf(this) && !neighborState.isOf(this.getPlant())) {
            ...
            return this.copyState(state, this.getPlant().getDefaultState().with(BeanstalkPlantBlock.BUDDING, true));
        }
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (isOpen) {
            ...
            if (hasLight) {
                ...
                NipperPlantEntity entity = ModEntities.NIPPER_PLANT.create(world.toServerWorld());
