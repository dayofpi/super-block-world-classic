...
public class PowerUpModel extends EntityModel<PlayerEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild("ears", ModelPartBuilder.create().uv(11, 12).mirrored().cuboid(1.0F, -11.0F, -1.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)).mirrored(false).uv(11, 12).cuboid(-4.0F, -11.0F, -1.0F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		modelPartData.addChild("cat_tail", ModelPartBuilder.create().uv(0, 12).cuboid(-1.0F, -0.5F, 1.25F, 2.0F, 2.0F, 7.0F, new Dilation(0.0F)).uv(0, 0).cuboid(-1.0F, -4.5F, 6.25F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 22.5F, 0.75F));
		...
		modelPartData.addChild("beehind", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -2.0F, 1.0F, 6.0F, 4.0F, 6.0F, new Dilation(0.0F)).uv(28, -2).cuboid(0.0F, -1.0F, 7.0F, 0.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 23.0F, 0.0F));
