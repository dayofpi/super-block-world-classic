...
import com.dayofpi.super_block_world.common.entities.goals.*;
...
public class BooEntity extends AbstractBoo implements Flutterer, Tameable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new BooFollowOwnerGoal(this, 1.0D, 10.0F, 2.0F));
        this.goalSelector.add(2, new BooPickupGoal(this));
