...
public class ConfiguredDecoration {
    ...
    public static final ConfiguredFeature<?, ?> SPRING = Feature.SPRING_FEATURE.configure(new SpringFeatureConfig(Fluids.WATER.getDefaultState(), true, 43, 1, ImmutableSet.of(BlockInit.VANILLATE, BlockInit.TOADSTOOL_SOIL)));
