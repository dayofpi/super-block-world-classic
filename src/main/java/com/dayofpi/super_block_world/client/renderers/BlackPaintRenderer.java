...
public class BlackPaintRenderer extends EntityRenderer<BlackPaintEntity> {
    private static final Identifier TEXTURE = new Identifier(Main.MOD_ID, "textures/item/black_paint.png");
    ...
    public BlackPaintRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
    ...
    public void render(BlackPaintEntity entity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        matrixStack.push();
    ...
    public Identifier getTexture(BlackPaintEntity entity) {
        return TEXTURE;
    }
}