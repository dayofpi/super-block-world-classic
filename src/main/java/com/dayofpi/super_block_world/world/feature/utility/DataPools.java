...
public class DataPools {
    ...
    public static final DataPool.Builder<BlockState> MUSHROOMS_GRASSLAND = DataPool.<BlockState>builder().add(MushroomBlocks.YELLOW_TOAD_STOOL.getDefaultState(), 1).add(MushroomBlocks.YELLOW_MUSHROOM.getDefaultState(), 2).add(Blocks.BROWN_MUSHROOM.getDefaultState(), 2).add(Blocks.RED_MUSHROOM.getDefaultState(), 1);
    ...
    public static final DataPool.Builder<BlockState> MUSHROOMS_AUTUMN = DataPool.<BlockState>builder().add(MushroomBlocks.ORANGE_TOAD_STOOL.getDefaultState(), 1).add(MushroomBlocks.ORANGE_MUSHROOM.getDefaultState(), 2).add(Blocks.RED_MUSHROOM.getDefaultState(), 1);
