...
public class ModFeatures {
    ...
    public static void registerFeatures() {
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "amanita_fruit"), AMANITA_FRUITS);
        ...
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "huge_brown_mushroom"), ModFeatures.HUGE_BROWN_MUSHROOM);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "huge_red_mushroom"), ModFeatures.HUGE_RED_MUSHROOM);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "dark_forest_vegetation_brown"), ModFeatures.DARK_FOREST_VEGETATION_BROWN);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "dark_forest_vegetation_red"), ModFeatures.DARK_FOREST_VEGETATION_RED);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(Main.MOD_ID, "mushroom_field_vegetation"), ModFeatures.MUSHROOM_FIELD_VEGETATION);
    }
