...
import com.dayofpi.sbw_main.common.block.type.BouncyMushroomBlock;
import com.dayofpi.sbw_main.common.block.type.MushroomCapBlock;
...
public class MushroomBlocks {
    ...
    public static final Block BROWN_MUSHROOM_CAP = new MushroomCapBlock(FabricBlockSettings.of(Material.SOLID_ORGANIC, MapColor.DIRT_BROWN).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK));
    ...
    public static final Block PURPLE_MUSHROOM_CAP = new MushroomCapBlock(FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.PURPLE));
    ...
    public static final Block GREEN_MUSHROOM_CAP = new MushroomCapBlock(FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.EMERALD_GREEN));
    public static final Block YELLOW_MUSHROOM_CAP = new MushroomCapBlock(FabricBlockSettings.copyOf(BROWN_MUSHROOM_CAP).mapColor(MapColor.YELLOW));
