...
import com.dayofpi.super_block_world.client.entity.model.*;
import com.dayofpi.super_block_world.client.entity.renderer.mob.*;
import com.dayofpi.super_block_world.client.entity.renderer.other.*;
...
public class EntityRendering {
    public static void registerEntityRenderers() {
        ...
        EntityRendererRegistry.register(EntityRegistry.STAR_BIT, FlyingItemEntityRenderer::new);
        ...
        EntityRendererRegistry.register(EntityRegistry.FIRE_BRO_FIREBALL, EnemyFireballRenderer::new);
        EntityRendererRegistry.register(EntityRegistry.ICEBALL, IceballRenderer::new);
        EntityRendererRegistry.register(EntityRegistry.ICE_BRO_ICEBALL, EnemyIceballRenderer::new);
        ...
        EntityRendererRegistry.register(EntityRegistry.PARAGOOMBA, GoombaRenderer::new);
        ...
        EntityRendererRegistry.register(EntityRegistry.ICE_BRO, IceBroRenderer::new);
        ...
        EntityRendererRegistry.register(EntityRegistry.FUZZY, FuzzyRenderer::new);
