package com.dayofpi.super_block_world.main.common.block.decoration.pipe;

import com.dayofpi.super_block_world.main.common.block_entity.WarpPipeBE;
import com.dayofpi.super_block_world.main.util.block_entity.WarpPipeTree;
...
public class WarpPipeBlock extends AbstractPipeBlock implements BlockEntityProvider {
    ...
    public void onBlockAdded(BlockState state, World world, BlockPos blockPos, BlockState oldState, boolean notify) {
        ...
        if (state.get(FACING) == Direction.UP) {
            warpPipeTree.addBlockToChunk(blockPos.getX()/16, blockPos.getZ()/16, blockPos); //Add to list
