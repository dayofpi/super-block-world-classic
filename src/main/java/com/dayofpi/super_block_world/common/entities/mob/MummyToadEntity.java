...
import com.dayofpi.super_block_world.common.entities.goals.MummyTargetGoal;
    ...
    public void onKilledOther(ServerWorld world, LivingEntity other) {
        ...
        if (other instanceof ToadEntity toadEntity) {
            ...
            if (mummyToadEntity != null) {
                ...
                mummyToadEntity.playSound(SoundInit.ENTITY_MUMMY_TOAD_MUMMIFY, 1.0F, this.getSoundPitch());
            }
        }
    }
