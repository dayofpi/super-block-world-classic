...
public class MagicBeamRenderer extends EntityRenderer<MagicBeamEntity> {
    private static final Identifier TEXTURE = new Identifier(Main.MOD_ID, "textures/item/magic_beam.png");
    ...
    public MagicBeamRenderer(EntityRendererFactory.Context context) {
        super(context);
    }
    ...
    protected int getBlockLight(MagicBeamEntity entity, BlockPos blockPos) {
        return 15;
    }

    public void render(MagicBeamEntity entity, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        matrixStack.push();
