...
public class ModEntities {
    ...
    public static final EntityType<GoKartEntity> GO_KART = FabricEntityTypeBuilder.<GoKartEntity>create(SpawnGroup.MISC, GoKartEntity::new).dimensions(EntityDimensions.fixed(1.0f, 0.5f)).trackRangeBlocks(10).build();
    ...
    public static final EntityType<KoopaTroopaEntity> KOOPA_TROOPA = FabricEntityTypeBuilder.createMob().entityFactory(KoopaTroopaEntity::new).spawnGroup(SpawnGroup.CREATURE).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, KoopaTroopaEntity::canKoopaSpawn).defaultAttributes(KoopaTroopaEntity::createKoopaAttributes).dimensions(EntityDimensions.fixed(0.8F, 1.3F)).build();
    public static final EntityType<LaunchStarEntity> LAUNCH_STAR = FabricEntityTypeBuilder.<LaunchStarEntity>create(SpawnGroup.MISC, LaunchStarEntity::new).dimensions(EntityDimensions.fixed(0.9F, 0.9F)).trackRangeBlocks(10).trackedUpdateRate(10).fireImmune().build();
    ...
    public static final EntityType<MechakoopaEntity> MECHAKOOPA = FabricEntityTypeBuilder.createMob().entityFactory(MechakoopaEntity::new).spawnGroup(SpawnGroup.MISC).defaultAttributes(MechakoopaEntity::createMechakoopaAttributes).dimensions(EntityDimensions.fixed(0.6F, 0.6F)).build();
    ...
    public static final EntityType<ParatroopaEntity> PARATROOPA = FabricEntityTypeBuilder.createMob().entityFactory(ParatroopaEntity::new).spawnGroup(SpawnGroup.CREATURE).spawnRestriction(SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ParatroopaEntity::canParatroopaSpawn).defaultAttributes(ParatroopaEntity::createParatroopaAttributes).dimensions(EntityDimensions.fixed(0.8F, 1.3F)).build();
    ...
    public static final EntityType<PropellerBlockEntity> PROPELLER_BLOCK = FabricEntityTypeBuilder.create(SpawnGroup.MISC, PropellerBlockEntity::new).dimensions(EntityDimensions.fixed(0.98f, 0.98f)).trackRangeBlocks(10).trackedUpdateRate(20).build();
    ...
    public static final EntityType<StampEntity> STAMP = FabricEntityTypeBuilder.<StampEntity>create(SpawnGroup.MISC, StampEntity::new).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).trackRangeBlocks(10).trackedUpdateRate(10).build();
    ...
    public static final EntityType<TrampolineMinecartEntity> TRAMPOLINE_MINECART = FabricEntityTypeBuilder.<TrampolineMinecartEntity>create(SpawnGroup.MISC, TrampolineMinecartEntity::new).dimensions(EntityDimensions.fixed(0.98f, 0.7f)).trackRangeBlocks(8).build();
    public static final EntityType<SuperPickaxEntity> SUPER_PICKAX = FabricEntityTypeBuilder.create(SpawnGroup.MISC, SuperPickaxEntity::new).dimensions(EntityDimensions.fixed(0.6f, 0.6f)).trackRangeBlocks(8).build();
    ...
    public static final EntityType<GhostEssenceEntity> GHOST_ESSENCE = FabricEntityTypeBuilder.<GhostEssenceEntity>create(SpawnGroup.MISC, GhostEssenceEntity::new).dimensions(EntityDimensions.fixed(0.9F, 0.9F)).trackRangeBlocks(8).build();
