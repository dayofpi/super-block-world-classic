...
public class Main implements ModInitializer {
    ...
    public void onInitialize() {
        DIMENSION = RegistryKey.of(Registry.DIMENSION_TYPE_KEY, new Identifier(Main.MOD_ID,"mushroom_kingdom"));
        ...
        CustomPortalBuilder.beginPortal()
                ...
                .tintColor(188, 112, 255).destDimID(DIMENSION_ID).flatPortal().registerPortal();
