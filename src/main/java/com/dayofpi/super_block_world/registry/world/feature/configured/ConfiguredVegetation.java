...
import com.dayofpi.super_block_world.registry.world.feature.placed.PlacedTrees;
...
public class ConfiguredVegetation {
    ...
    public static final ConfiguredFeature<?, ?> VEGETATION_REEF = Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(List.of(new RandomFeatureEntry(ConfiguredPlants.FLOWERBED.withPlacement(), 0.42F)), PlacedTrees.BELL_PINE));
