...
public class PlacedDecoration {
    ...
    public static final PlacedFeature CAVE_DECORATION_LOW = ConfiguredDecoration.CAVE_DECORATION_LOW.withPlacement(SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.fixed(-20), YOffset.fixed(0)), BiomePlacementModifier.of());
    public static final PlacedFeature TOPPING = ConfiguredDecoration.TOPPING.withPlacement(CountPlacementModifier.of(28), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.fixed(50)), BiomePlacementModifier.of());
    public static final PlacedFeature FROSTING = ConfiguredDecoration.FROSTING.withPlacement(CountPlacementModifier.of(28), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.aboveBottom(0), YOffset.belowTop(0)), BiomePlacementModifier.of());
