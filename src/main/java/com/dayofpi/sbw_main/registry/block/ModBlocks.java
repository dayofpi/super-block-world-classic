...
import com.dayofpi.sbw_main.common.block.type.*;
import com.dayofpi.sbw_main.common.block.type.warp_pipe.BronzePipeBlock;
import com.dayofpi.sbw_main.common.block.type.warp_pipe.WarpPipeBlock;
import com.dayofpi.sbw_main.common.block.type.warp_pipe.WarpPipeBodyBlock;
import com.dayofpi.sbw_main.util.mixin_aid.ModSignType;
import com.dayofpi.sbw_main.util.sounds.ModSoundGroup;
...
public class ModBlocks {
    ...
    public static final Block FROSTY_TOPPED_VANILLATE_ORE = new FrostyVanillateOre(FabricBlockSettings.copyOf(FROSTY_VANILLATE).emissiveLighting(ModBlocks::always).slipperiness(1.0F));
    ...
    public static final Block DARK_AMANITA_LEAVES = new LeavesBlock(FabricBlockSettings.of(Material.LEAVES).strength(0.2F).ticksRandomly().sounds(BlockSoundGroup.GRASS).nonOpaque().allowsSpawning(ModBlocks::canSpawnOnLeaves).suffocates(ModBlocks::never).blockVision(ModBlocks::never));
    ...
    public static final Block DARK_AMANITA_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copyOf(DARK_AMANITA_PLANKS).strength(3.0F).nonOpaque().allowsSpawning(ModBlocks::never)){};
