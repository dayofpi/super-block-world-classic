package com.dayofpi.super_block_world.main.common.entity.mob.npc;

import com.dayofpi.super_block_world.client.sound.SoundInit;
import com.dayofpi.super_block_world.main.Main;
import com.dayofpi.super_block_world.main.common.block_entity.QuestionBoxBE;
import com.dayofpi.super_block_world.main.common.entity.mob.EnemyEntity;
import com.dayofpi.super_block_world.main.common.entity.goal.OpenDoorsGoal;
import com.dayofpi.super_block_world.main.common.entity.goal.ToadLookGoal;
...
public class ToadEntity extends AbstractToad implements IAnimatable {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new FleeEntityGoal<>(this, EnemyEntity.class, 3.0f, 1.3, 1.5));
    ...
    public void tickMovement() {
        super.tickMovement();
        if (this.isAlive()) {
            List<Entity> baddies = world.getOtherEntities(this, this.getBoundingBox().expand(8, 4, 8), entity -> entity instanceof EnemyEntity || entity instanceof AbstractGhost || entity instanceof HostileEntity);
            if (!this.isScared()) {
    ...
    protected ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (itemStack.isOf(ItemInit.COIN) && !this.isBaby() && !this.isScared() && !this.isCheering()) {
            if (!this.world.isClient && this.getReceivedCoins() < this.getWantedCoins()) {
                ...
                this.playSound(SoundInit.ITEM_COIN_COLLECT, 0.8F, 1.0F);
