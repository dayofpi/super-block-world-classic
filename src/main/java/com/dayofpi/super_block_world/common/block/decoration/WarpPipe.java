...
import com.dayofpi.super_block_world.common.block_entity.WarpPipeBE;
...
public class WarpPipe extends AbstractPipe implements BlockEntityProvider {

    public static final WarpPipeTree warpPipeTree = new WarpPipeTree();

    public WarpPipe(Settings settings) {
        super(settings);
    }
