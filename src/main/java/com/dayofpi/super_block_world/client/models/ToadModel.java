...
public class ToadModel<T extends ToadEntity> extends AnimatedGeoModel<T> {
    ...
    public void setLivingAnimations(T entity, Integer uniqueID, AnimationEvent customPredicate) {
        ...
        final IBone LEFT_TWINTAIL = this.getAnimationProcessor().getBone("left_twintail");
        final IBone RIGHT_TWINTAIL = this.getAnimationProcessor().getBone("right_twintail");
